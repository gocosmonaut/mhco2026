...
class SharedEmailSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['sharedemail_msg'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Shared Email message'),
      '#default_value' => $config->get('sharedemail_msg'),
      '#description' => $this->t('Warning message that is only displayed to users with appropriate permission, when they choose to save an email address already used by another user.'),
    ];

    $form['sharedemail_allowed'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Shared Email address allowlist'),
