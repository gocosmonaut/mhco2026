...
class ParkDirectoryForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['mnuCounty'] = [
      ...
      // Optional: Pre-select a value.
      '#default_value' => '00Select',
      // Optional: Make it required if needed.
      '#required' => FALSE,
    ...
    // ID of the div to replace with response.
