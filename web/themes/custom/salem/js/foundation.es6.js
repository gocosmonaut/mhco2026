  ...
  _watcher: function _watcher() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize.zf.trigger', function () {
      ...
      if (newSize !== currentSize) {
        ...
        _this3.current = newSize; // Broadcast the media query change on the window
  ...
  _createClass(Abide, [{
    ...
    value: function validateForm() {
      ...
      this.$element.find('[data-abide-error]').each(function (i, elem) {
        ...
        if (_this10.options.a11yAttributes) _this10.addGlobalErrorA11yAttributes($elem); // Show or hide the error
    ...
    value: function _init() {
      ...
      this._checkDeepLink = function () {
        ...
        if (!anchor.length) {
          ...
          if (_this13._isInitializing) return; // Otherwise, move to the initial anchor
        ...
        var $link = anchor && _this13.$element.find("[href$=\"".concat(anchor, "\"]")); // Whether the anchor element that has been found is part of this element
  ...
  _createClass(Tabs, [{
    ...
    value: function _init() {
      ...
      this._checkDeepLink = function () {
        ...
        if (!anchor.length) {
          // If we are still initializing and there is no anchor, then there is nothing to do
          if (_this34._isInitializing) return; // Otherwise, move to the initial anchor
        ...
        var $link = anchor && _this34.$element.find("[href$=\"".concat(anchor, "\"],[data-tabs-target=\"").concat(anchorNoHash, "\"]")).first(); // Whether the anchor element that has been found is part of this element
